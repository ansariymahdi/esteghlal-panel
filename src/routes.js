...
const routes = [
    { path: '/menu/dashboard', exact: true, name: 'Default', component: DashboardDefault, hasAuth: true },
    { path: '/menu/playerProgram', exact: true, name: 'PlayerProgramDefault', component: PlayerProgramDefault, hasAuth: true },
    { path: '/menu/createPullGame', exact: true, name: 'CreatePullGameDefault', component: CreatePullGameDefault, hasAuth: true },
    // { path: '/auth/login', exact: true, name: 'Signup 1', component: Login, hasAuth: false },
    // { path: '/auth/signin-1', exact: true, name: 'Signin 1', component: Signin1, hasAuth: false },
    // { path: '/notFound', exact: true, name: 'error', component: ErrorPage, hasAuth: false }
