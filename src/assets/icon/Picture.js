...
function Picture(props) {
  return (
    <svg height="1em" viewBox="0 0 510 510" width="1em" {...props}>
      <linearGradient
        id="prefix__c"
      ...
      <linearGradient id="prefix__b">
        <stop offset={0} style={{ stopColor: "#cdec7a", stopOpacity: 0 }} />
        <stop offset={0.235} style={{ stopColor: "#9ad57d", stopOpacity: 0.235 }} />
        <stop offset={0.604} style={{ stopColor: "#51b482", stopOpacity: 0.604 }} />
        <stop offset={0.868} style={{ stopColor: "#239f85", stopOpacity: 0.868 }} />
        <stop offset={1} style={{ stopColor: "#119786", stopOpacity: 0.868 }} />
      </linearGradient>
      <linearGradient
        id="prefix__f"
        gradientUnits="userSpaceOnUse"
      ...
      <path
        ...
        fill="url(#prefix__k)"
      />
      <circle cx={137.225} cy={157.919} fill="url(#prefix__l)" r={40.219} />
    </svg>
  );
}

const MemoPicture = React.memo(Picture);
export default MemoPicture;
